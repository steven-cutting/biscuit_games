<script module lang="ts">
  ...
  const OVERVIEW = [
    "The small uppercase label that names a group — the platform's one decorative typographic",
    'device, and the only place it uppercases anything. Everywhere else is sentence case, and',
    'a sentence is never uppercased. `docs/design/tokens.md` states that rule; this is what',
    'spends it.',
    '',
