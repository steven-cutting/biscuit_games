<script module lang="ts">
  ...
  const OVERVIEW = [
    ...
    'the floors `appearance.allium` states, in all four combinations of theme and high contrast.',
    ...
    'itself generated from `docs/design/direction.md`; the specimens came from Poodl by',
    'decision 0014.'
  ].join('\n');
...
<Story name="Type" asChild>
  <div class="sheet">
    <p class="spec display-1">biscuit games</p>
    <p class="spec display-3">Bricolage Grotesque carries display</p>
...
<!-- The spacing scale and the radii, drawn to size. -->
